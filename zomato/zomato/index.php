...
<body>
  <header>
    <nav class="navbar">
      ...
      <div class="navbar__nav__items">
        <div class="nav__item">
          <button class="primary__button">Order Food</button>
        </div>
      </div>
    </nav>
  </header>
  <main class="container">
    <section class="hero__container">
      ...
      <p class="food__menu__card__resturant">Burger King, Mcdonalds, Burger Place <span style="color:red;">+3</span></p>
      </div>
      ...
      <p class="food__menu__card__resturant">Pizza Hut, Domino's Pizza <span style="color:red;">+3</span></p>
      </div>
      ...
      <p class="food__menu__card__resturant">Baskin Robins, Ibaco <span style="color:red;">+3</span></p>
      </div>
    ...
    <button id="install-button" class="primary__button" style="display: none;">Install App</button>
  </main>
  <footer>
